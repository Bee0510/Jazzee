...
class savedJobDetailsScreen extends StatefulWidget {
  const savedJobDetailsScreen({Key? key, this.job, required this.student})
      : super(key: key);
  final JobSaved? job;
  final Student student;
  @override
  State<savedJobDetailsScreen> createState() => _savedJobDetailsScreenState();
}

class _savedJobDetailsScreenState extends State<savedJobDetailsScreen> {
                        ...
                        onPressed: () async {
                          ...
                          final result = await SendJobApplyInfo()
                            ...
                            await supabase
                                ...
                                .eq('student_id', widget.student.studentId);
